<footer id="footer">
    <div class="footer__content fx-row">
        <div class="footer__content-info fx-col flex-center">
            <a class="footer__info--logo txt-col-white fx-row">{{$generalSettings->site_name}}</a>
            <div class="footer__info--contacts txt-col-white fx-col">
        ...
        <div class="footer__content-map fx-row flex-center">
            <ul class="footer__content-map_list">
                <li class="_footer__menu_item fx-row flex-center">
                    <a href="{{route('home')}}" title="home" class="txt-col-white">
                        home
                    </a>
                </li>
                @foreach($menus as $menu)
                    <li class="_footer__menu_item fx-row flex-center">
                        <a href="{{$menu->link}}" title="{{$menu->title}}" class="txt-col-white">
                            {{$menu->title}}
                        </a>
                    </li>
                @endforeach
